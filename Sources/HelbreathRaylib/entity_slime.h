...
// Slime entity - simple monster entity
class EntitySlime : public Entity {
public:
	EntitySlime();
	~EntitySlime() override = default;
	...
	// Get the entity type
	static constexpr EntityID GetEntityType() { return EntityID::SLIME; }
...
protected:
	...
	// Death overrides - play death sound
	void on_after_death() override;
